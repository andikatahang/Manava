...
// team roster (Departemen Saya), Presensi & Cuti, KPI Tim, and Proyek Tim.
type Tab = 'anggota' | 'presensi' | 'kpi' | 'proyek'

const TABS: { key: Tab; label: string; icon: typeof Users }[] = [
  { key: 'anggota',  label: 'Anggota',        icon: Users },
  { key: 'presensi', label: 'Presensi & Cuti', icon: Clock },
...
export default function TeamDashboardPage({ role }: { role: UserRole }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {tab === 'presensi' && <AttendancePage role={role} embedded />}
